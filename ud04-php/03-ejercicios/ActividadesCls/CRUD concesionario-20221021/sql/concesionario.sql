...
(
    ...
    marca VARCHAR(50),
    precio DECIMAL(12,2),
    stock DECIMAL(5) -- ¿Stock de 99.999 chcoes?, por defecto DECIMAL es 10
...
(
    -- id BIGINT AUTO_INCREMENT PRIMARY KEY, en un sistema CRUD con millones de filas una clave primaria
    -- sintética como 'id' podría ser deseable para no ralentizar el sistema, en cuyo caso quitaríamos
    -- la clave primaria compuesta y dejaríamos sólo 'id' en lugar de (coche_id,cliente_id)
    id BIGINT AUTO_INCREMENT,
    coche_id BIGINT,
    cliente_id BIGINT,
    cantidad DECIMAL(4), -- ¿Son suficientes 9999 coches?
    fecha date,
