...
| UD2a | 30 % restante de evaluación | No publicado en `EVALUACION.md` | No especificada | Desconocida | Mantener pendiente; decidir si será hito individual 1, cuestionario acumulativo o combinación aprobada | `ud02-api-rest/ud02a-spring-boot/EVALUACION.md` |
