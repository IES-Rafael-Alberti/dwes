...
public class TaskControllerV3 {
    ...
    public TaskControllerV3(TaskRepository repo) { this.repo = repo; }
    ...
    public Task create(@RequestBody @jakarta.validation.Valid CreateTaskDTO dto) {
        return repo.save(new Task(dto.title()));
    }
