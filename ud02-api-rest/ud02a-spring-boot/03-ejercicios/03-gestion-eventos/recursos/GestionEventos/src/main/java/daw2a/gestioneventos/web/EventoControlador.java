...
public class EventoControlador {
    ...
    @PutMapping("agregar-participante/{idEvento}/{idParticipante}")
    public ResponseEntity<EventoResponseDTO> agregarParticipante(@PathVariable Long idEvento, @PathVariable Long idParticipante) {
        EventoResponseDTO eventoActualizado = eventoServicio.agregarParticipante(idEvento, idParticipante);
