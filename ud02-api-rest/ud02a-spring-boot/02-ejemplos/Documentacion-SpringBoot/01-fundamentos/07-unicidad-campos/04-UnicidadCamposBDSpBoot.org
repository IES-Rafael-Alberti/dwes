...
public class UniqueValueValidator implements ConstraintValidator<UniqueValue, Object> {
    ...
    public boolean isValid(Object value, ConstraintValidatorContext context) {
        ...
        Query query = entityManager.createQuery(
                "SELECT COUNT(e) FROM " + entityClass.getName() + " e WHERE e." + fieldName + " = :value"
        );
        query.setParameter("value", value);

        Long count = (Long) query.getSingleResult();
        return count == 0;  // Retorna verdadero si no existe, es decir, es único
    }
}
#+end_src
...
public class Usuario {
    ...
    @UniqueValue(entity = Usuario.class, fieldName = "email", message = "El email ya está registrado")
    @Column(nullable = false)
    private String email;
