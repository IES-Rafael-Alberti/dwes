...
|---|---|---|---|---|---|
| Propuesta y aprobación | Dominio, problema, usuarios, reglas, alcance de servidor y stack. | Issue, tarjeta o documento inicial enlazado al repositorio. | Validar viabilidad, no trivialidad y límites. | Tema aprobado antes de consolidar desarrollo. | Reducir alcance y aclarar responsabilidad individual/equipo. |
| Fundación y modelo | Arquitectura inicial, modelo y migración inicial; arranque local. | Commit/release o etiqueta de hito y tarea enlazada. | Revisar separación de responsabilidades y modelo. | El esquema se reproduce y una ruta mínima funciona. | Corregir modelo o migraciones antes de acumular funcionalidades. |
...
| Integración, pruebas y documentación | Cliente integrado si existe, pruebas, OpenAPI si hay API, README/runbook. | Etiqueta/release, enlaces a documentación y resultado de pruebas. | Revisar reproducibilidad y trazabilidad. | Otra persona puede arrancar y probar el servidor siguiendo el repositorio. | Simplificar integración, reparar contratos y documentar el camino mínimo. |
