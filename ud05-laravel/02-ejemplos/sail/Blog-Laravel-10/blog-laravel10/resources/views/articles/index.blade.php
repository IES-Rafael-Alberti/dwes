...
<section class="text-gray-600 body-font overflow-hidden">
    <div class="container px-5 py-24 mx-auto">
        <div class="mb-16 -my-8">
            ...
            class="flex w-64 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
...
{{ $article->category->name }}
                ...
                <div class="md:flex-grow">
                    ...
                    class="text-indigo-500 inline-flex items-center mt-4">{{ __("Ver detalle") }}
