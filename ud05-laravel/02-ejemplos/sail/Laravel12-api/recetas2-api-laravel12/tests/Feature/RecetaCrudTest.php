...
class RecetaCrudTest extends TestCase
{
    ...
    public function test_authenticated_user_can_create_receta(): void
    {
        ...
        $response->assertStatus(201)
            ->assertJsonPath('data.titulo', 'Tortilla de patatas');
    ...
    public function test_create_receta_validates_required_fields(): void
    {
        [, $token] = $this->authUser();
        ...
        $this->withHeader('Authorization', 'Bearer ' . $token)
            ->postJson('/api/recetas', [])
            ->assertUnprocessable()
            ->assertJsonValidationErrors(['titulo', 'descripcion', 'instrucciones']);
    }
    ...
    public function test_can_view_single_receta(): void
    {
        ...
        $this->withHeader('Authorization', 'Bearer ' . $token)
            ...
            ->assertStatus(200)
            ->assertJsonPath('data.titulo', $receta->titulo);
    }
