...
La [práctica incremental](../ud06-aplicaciones-hibridas/03-ejercicios/practica-integracion/README.md) define entregables observables y verificaciones offline para RA9.a-h. La [guía de seguridad](../ud06-aplicaciones-hibridas/06-seguridad/README.md) aporta el modelo de amenazas y la lista de auditoría que acompaña a la entrega.
...
| P2A | Práctica incremental, evidencia RA9.a-h y seguridad transversal | **Completado** |
